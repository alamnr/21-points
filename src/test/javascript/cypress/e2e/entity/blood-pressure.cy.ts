...
describe('BloodPressure e2e test', () => {
  ...
  const bloodPressureSample = { date: '2023-06-22T03:03:51.606Z', systolic: 27476, diastolic: 27392 };
  ...
  describe('new BloodPressure page', () => {
    ...
    it('should create an instance of BloodPressure', () => {
      cy.get(`[data-cy="date"]`).type('2023-06-21T14:38').blur().should('have.value', '2023-06-21T14:38');
