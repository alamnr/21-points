...
type RestOf<T extends IBloodPressure | NewBloodPressure> = Omit<T, 'date'> & {
  date?: string | null;
};
...
export class BloodPressureService {
  ...
  protected convertDateFromClient<T extends IBloodPressure | NewBloodPressure | PartialUpdateBloodPressure>(bloodPressure: T): RestOf<T> {
    return {
      ...bloodPressure,
      date: bloodPressure.date?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restBloodPressure: RestBloodPressure): IBloodPressure {
    return {
      ...restBloodPressure,
      date: restBloodPressure.date ? dayjs(restBloodPressure.date) : undefined,
    };
  }
